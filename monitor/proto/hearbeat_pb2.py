...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=_b('\n\x0ehearbeat.proto\"$\n\x08NodeInfo\x12\n\n\x02ip\x18\x01 \x01(\t\x12\x0c\n\x04port\x18\x02 \x01(\t\"R\n\x05Stats\x12\x11\n\tcpu_usage\x18\x01 \x01(\t\x12\x10\n\x08\x63pu_data\x18\x02 \x01(\t\x12\x12\n\ndisk_space\x18\x03 \x01(\t\x12\x10\n\x08used_mem\x18\x04 \x01(\t21\n\x0fHearBeatService\x12\x1e\n\x07isAlive\x12\t.NodeInfo\x1a\x06.Stats\"\x00\x62\x06proto3')
)
...
_STATS = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='cpu_data', full_name='Stats.cpu_data', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='disk_space', full_name='Stats.disk_space', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='used_mem', full_name='Stats.used_mem', index=3,
...
_HEARBEATSERVICE = _descriptor.ServiceDescriptor(
  name='HearBeatService',
  full_name='HearBeatService',
  file=DESCRIPTOR,
  index=0,
  serialized_options=None,
  ...
  _descriptor.MethodDescriptor(
    name='isAlive',
    full_name='HearBeatService.isAlive',
    index=0,
...
_sym_db.RegisterServiceDescriptor(_HEARBEATSERVICE)

DESCRIPTOR.services_by_name['HearBeatService'] = _HEARBEATSERVICE
